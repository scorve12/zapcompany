...
품고(Poomgo)를 참고하여 제작한 물건 구매대행 서비스 웹사이트입니다. 무채색을 사용한 세련되고 믿음직한 디자인으로, 구매대행 문의 기능을 중심으로 설계되었습니다.

## 주요 기능

- **메인 페이지**: 회사 소개, 특장점, 주요 카테고리, 신뢰 지표
- **구매대행 문의**: 상세한 폼을 통한 견적 요청 시스템
